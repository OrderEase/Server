...
class FlaskClientTest(unittest.TestCase):
    ...
    def test_postOrder(self):
        response = self.client.post('http://localhost:5000/api/order/cuid/1', 
                                data=self.myorder1)
        self.assertTrue(200 == response.status_code)
    ...
    def test_getOrder(self):
        ...
        response = self.client.get('http://localhost:5000/api/order/cuid/1/oid/1')
        self.assertTrue(200 == response.status_code)
    ...
    def test_payOrder(self):
        ...
        response = self.client.put('http://localhost:5000/api/order/cuid/1/oid/1', 
                                data={'payId': 100})
        self.assertTrue(200 == response.status_code)
