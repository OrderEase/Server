...
#         response = self.client.post(url, data=self.dishes[0])
#         self.assertTrue(200==response.status_code)
#         response = self.client.post(url, data=self.dishes[1])
#         self.assertTrue(200==response.status_code)

#         url = 'http://localhost:5000/api/menus/' \
#                 + str(menuid) + '/categories/' + str(catid1) + '/dishes/'
#         response = self.client.post(url, data=self.dishes[2])
#         self.assertTrue(200==response.status_code)
#         response = self.client.post(url, data=self.dishes[3])
#         self.assertTrue(200==response.status_code)
...
#                 + '/dishes/' + str(dishid)
#         response = self.client.put(url, data={'name': '白灼许琦'})
#         self.assertTrue(200==response.status_code)
